<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="header">LEAVE MANAGE</li>
        <li><a href="http://bkarogyadham.com/elms/leaveadmin/dashboard.php" target="_blank"><i class="fa fa-dashboard"></i> <span>ELMS</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>